    ...
    balance(config = {}) {
        return this.children.length <= 8
            ...
            : balanceRange(
                  ...
                  config.makeTree ||
                      ((children, positions, length) =>
                          new _Tree(NodeType.none, children, positions, length))
              )
    }
    /**
    ...
    function divide(children2, positions2, from2, to2, offset) {
        for (let i = from2; i < to2; ) {
            ...
            if (i == groupFrom + 1) {
                ...
                let length2 =
                    positions2[i - 1] + children2[i - 1].length - groupStart
                localChildren.push(
                    balanceRange(
                        balanceType,
                        children2,
...
var TreeFragment = class _TreeFragment {
  ...
  */
    static addTree(tree, fragments = [], partial = false) {
        let result = [
            new _TreeFragment(0, tree.length, tree, 0, false, partial),
        ]
    ...
    findMounts(pos, parser) {
        ...
        if (this.inner) {
            ...
            for (let pos2 = this.inner.cursor.node; pos2; pos2 = pos2.parent) {
                let mount =
                    (_a = pos2.tree) === null || _a === void 0
                        ? void 0
                        : _a.prop(NodeProp.mounted)
